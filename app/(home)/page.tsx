    ...
    <main className="text-landing-foreground pt-4 pb-6 dark:text-landing-foreground-dark md:pb-12">
      ...
      <div className="grid grid-cols-1 gap-10 mt-12 px-6 mx-auto w-full max-w-[1400px] md:px-12 lg:grid-cols-2">
        <p className="text-2xl tracking-tight leading-snug font-light col-span-full md:text-3xl xl:text-4xl">
          Bebra is a <span className="text-brand font-medium">premium</span>{' '}
         shop for{' '}
          <span className="text-brand font-medium">Developers</span>,
          and someone else{' '}
          <span className="text-brand font-medium">Gods</span>. Bringing
          powerful features for your docs workflows, with high customizability
          to fit your preferences, works seamlessly with any.
        </p>
